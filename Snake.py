...
class Snake:
    def __init__(self):
        ...
        self.__headXChange = 0
        self.__headYChange = 0
    ...
    def __drawSnake(self, snakeSize, snakeList):
        ...
        while not self.__completed:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    self.__headXChange = self.__direction[0]
                    self.__headYChange = self.__direction[1]

            # headX / headY is the position of snake head and
            # it changes depending on headXChange / headYChange
            self.__headX += self.__headXChange
            self.__headY += self.__headYChange

            # # if snake head goes past screen, game over
            # if self.__headX > 640 or self.__headX < 0 \
            #    or self.__headY > 480 or self.__headY < 0:
            #     self.__state = 3
            #     self.__gameOver = True
            ...
            snakeHead.append(self.__headX)
            snakeHead.append(self.__headY)
            ...
            self.__drawSnake(self.__snakeSize, self.__snakeList)
            ...
            # if self.__headX == self.__randAppleX and
            # self.__headY == self.__randAppleY:
