...
class Simon:
    ...
    def __gameFlashBrightRect(self):
        ...
        for num in self.__sequence:
            ...
            if self.__keyFlag:
                ...
                try:
                    self.__pressList.append(self.__pressKey(event))
                except AttributeError:
                    print("Sorry Something went wrong try again!")
                    self.__state = 3
                    self.__gameOver = True
    ...
    def __displayInstructions(self):
